...
CREATE INDEX idx_identity_role_form_a ON idm_role_form_value (owner_id);
CREATE INDEX idx_identity_role_form_a_def ON idm_role_form_value (attribute_id);
CREATE INDEX idx_identity_role_form_stxt ON idm_role_form_value (short_text_value);
CREATE INDEX idx_identity_role_form_uuid ON idm_role_form_value (uuid_value);
...
ALTER TABLE idm_role ADD identity_role_attr_def_id binary(16) NULL;

ALTER TABLE idm_role_a ADD identity_role_attr_def_id binary(16) NULL;
ALTER TABLE idm_role_a ADD identity_role_attribute_definition_m bit NULL;
