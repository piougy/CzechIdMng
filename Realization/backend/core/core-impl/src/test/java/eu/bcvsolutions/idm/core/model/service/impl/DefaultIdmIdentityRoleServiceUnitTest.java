...
public class DefaultIdmIdentityRoleServiceUnitTest extends AbstractUnitTest {
	...
	public void testDuplicityValidNoRoleWithContract() {
		...
		allByIdentity.forEach(ir -> 
			((IdmIdentityContractDto) ir.getEmbedded().get(IdmIdentityRoleDto.PROPERTY_IDENTITY_CONTRACT)).setValidTill(new LocalDate().plusDays(10))
		);
	...
	public void testSubdefinitionManuallyLong() {
		...
		IdmRoleDto role = new IdmRoleDto(UUID.randomUUID());
		//
		IdmIdentityRoleDto one = prepareIdentityRole(contract, role, new LocalDate().minusDays(10), new LocalDate().plusDays(10));
		IdmIdentityRoleDto two = prepareIdentityRole(contract, role, new LocalDate().minusDays(5), new LocalDate().plusDays(5));
	...
	public void testSubdefinitionManuallyShortText() {
		...
		IdmIdentityRoleDto one = prepareIdentityRole(contract, role, new LocalDate().minusDays(10), new LocalDate().plusDays(10));
		IdmIdentityRoleDto two = prepareIdentityRole(contract, role, new LocalDate().plusDays(15), new LocalDate().plusDays(20));
	...
	private IdmIdentityRoleDto prepareIdentityRole(IdmIdentityContractDto identityContract, IdmRoleDto role, LocalDate validFrom, LocalDate validTill) {
		...
		identityRole.setCreated(DateTime.now());
		//
