# NotificationTemplateInfo Component

Information about notification templates. If template doesn't exist, then short template's identifier will be shown.
...
```html
<Advanced.NotificationTemplateInfo entity={{ name: 'notificationTemplate' }}/>
```

or

```html
<Advanced.NotificationTemplateInfo entityIdentifier="notificationTemplate" />
```
