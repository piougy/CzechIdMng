...
class ApprovalTaskService extends AbstractService {

  getApiPath() {
    return '/idm/seam/resource/api-v1/approval-tasks';
  }
  ...
  /**
   * Applicant for task with this idTask
   * @param  {string} idTask
...
export default ApprovalTaskService;
