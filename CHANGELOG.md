...
- [#1287](https://redmine.czechidm.com/issues/1287) - New generate type for passwords - prefixes and suffixes) Is possible create new generated password policy that allow generate random password with prefixes and suffixes. Both strings are optional and can be setup only for generated password policy.
