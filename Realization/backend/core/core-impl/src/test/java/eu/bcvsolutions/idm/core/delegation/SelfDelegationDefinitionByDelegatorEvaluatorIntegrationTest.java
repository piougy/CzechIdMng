 ...
 */
@Transactional
public class SelfDelegationDefinitionByDelegatorEvaluatorIntegrationTest extends AbstractEvaluatorIntegrationTest {
	...
	public void testPolicy() {
		...
		;
		getHelper().createDelegation(identity, delegator); // other
		...
		getHelper().createAuthorizationPolicy(
				...
				SelfDelegationDefinitionByDelegatorEvaluator.class,
