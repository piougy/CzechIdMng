...
class SyncRoleConfig extends Basic.AbstractContent {
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            roleAttributeSearchParameters: new Domain.SearchParameters().setFilter('systemMappingId', props.synchronizationConfig ? props.synchronizationConfig.systemMapping : Domain.SearchParameters.BLANK_UUID),
    ...
    _onChangeMemberSystem(systemMapping) {
        ...
        this.setState({
            ...
            membersAttributeSearchParameters: this.state.membersAttributeSearchParameters.setFilter('systemMappingId', systemMappingId || Domain.SearchParameters.BLANK_UUID),
            identitySchemaAttributeSearchParameters: this.state.identitySchemaAttributeSearchParameters.setFilter('objectClassId', objectClassId || Domain.SearchParameters.BLANK_UUID)
        }, () => {
    ...
    render() {
        ...
        const hiddenMemberIdentifierAttribute = !assignRoleSwitch || membersAttributeSearchParameters.getFilters().get('systemMappingId') === Domain.SearchParameters.BLANK_UUID;
        ...
        const forwardAcmMappingAttribute = synchronizationConfig && synchronizationConfig.forwardAcmMappingAttribute ? synchronizationConfig._embedded.forwardAcmMappingAttribute : null;
        const skipValueIfExcludedMappingAttribute = synchronizationConfig && synchronizationConfig.skipValueIfExcludedMappingAttribute ? synchronizationConfig._embedded.skipValueIfExcludedMappingAttribute : null;
        const roleIdentifiersMappingAttribute = synchronizationConfig && synchronizationConfig.roleIdentifiersMappingAttribute ? synchronizationConfig._embedded.roleIdentifiersMappingAttribute : null;
        const assignCatalogueMappingAttribute = synchronizationConfig && synchronizationConfig.assignCatalogueMappingAttribute ? synchronizationConfig._embedded.assignCatalogueMappingAttribute : null;
        const roleMembersMappingAttribute = synchronizationConfig && synchronizationConfig.roleMembersMappingAttribute ? synchronizationConfig._embedded.roleMembersMappingAttribute : null;
