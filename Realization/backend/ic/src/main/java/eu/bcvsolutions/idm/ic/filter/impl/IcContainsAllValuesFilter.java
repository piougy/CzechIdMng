...
public class IcContainsAllValuesFilter extends IcAttributeFilter {
     ...
     * {@link IcFilterBuilder} to create an instance of
     * {@code IcContainsAllValuesFilter}.
     *
     * @param attr
     */
    public IcContainsAllValuesFilter(IcAttribute attr) {
        super(attr);
        name = attr.getName();
    ...
    /**
     * Determine whether the specified {@link IcConnectorObject} contains an
     * {@link IcAttribute} that has the same name as
     * <em>and contains all of the values of</em> the attribute that
     * {@link IcFilterBuilder} placed into this filter.
     *
     * {@inheritDoc}
     */
    @Override
    public boolean accept(IcConnectorObject obj) {
        IcAttribute found = obj.getAttributeByName(name);
        if (found != null) {
            // TODO: possible optimization using 'Set'
        	List<Object> value = found.getValues();
        	if (value == null) {
