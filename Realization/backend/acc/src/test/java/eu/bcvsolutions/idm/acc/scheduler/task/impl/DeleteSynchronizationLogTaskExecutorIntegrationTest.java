...
public class DeleteSynchronizationLogTaskExecutorIntegrationTest extends AbstractIntegrationTest {
	...
	public void testDeleteOldSynchronizationLogs() {
		...
		createDto(syncConfigOne, DateTime.now().withTimeAtStartOfDay().plusMinutes(1));
		createDto(syncConfigOne, DateTime.now().withTimeAtStartOfDay().minusHours(23));
		SysSyncLogDto logOther = createDto(syncConfigOther, DateTime.now().minusDays(2));
		//
