...
describe('AbstractService', function() {
  ...
  it('- constructor of DefaultAbstractService should not throw TypeError exception (getApiPath method ids defined) ', function() {
    expect(() => { this.defaultAbstractService = new DefaultAbstractService(); }).to.not.throw(TypeError);
  });

  it('- default search parameters should be sorted by id asc', function() {
  ...
  it('- default search parameters should not contain a filters', function() {
  ...
  describe('[#mergeSearchParameters]', function() {
    ...
    it('- merge default search parameters with user defined search parameters - user defined search parameters has higher priority', function() {
