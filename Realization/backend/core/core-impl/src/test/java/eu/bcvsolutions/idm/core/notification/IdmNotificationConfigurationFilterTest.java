...
public class IdmNotificationConfigurationFilterTest extends AbstractIntegrationTest {
	...
	public void testTopicFilter() {
		...
		IdmNotificationConfigurationDto notification = createNotification(NotificationLevel.SUCCESS, CoreModuleDescriptor.MODULE_ID + ":test001", text,
				null);
		...
		Page<IdmNotificationConfigurationDto> result = idmNotificationConfService.find(filter, null);
	...
	public void testLevelFilter() {
		String text = "someText" + System.currentTimeMillis();
		IdmNotificationConfigurationDto notification = createNotification(NotificationLevel.ERROR, CoreModuleDescriptor.MODULE_ID + ":test002", text,
				null);
		IdmNotificationConfigurationFilter filter = new IdmNotificationConfigurationFilter();
	...
	public void testTemplateIdFilter() {
		...
		IdmNotificationTemplateDto templ = createTemplate("template " + System.currentTimeMillis(), "code",
				"testFilter");
		IdmNotificationConfigurationDto notification = createNotification(NotificationLevel.SUCCESS, CoreModuleDescriptor.MODULE_ID + ":test003", text,
				templ.getId());
		IdmNotificationConfigurationFilter filter = new IdmNotificationConfigurationFilter();
	...
	public void testNotificationTypeFilter() {
		String text = "someText" + System.currentTimeMillis();
		IdmNotificationConfigurationDto notification = createNotification(NotificationLevel.SUCCESS, CoreModuleDescriptor.MODULE_ID + ":test004", text,
				null);
		IdmNotificationConfigurationFilter filter = new IdmNotificationConfigurationFilter();
		filter.setNotificationType(text);
	 ...
	 * 
	 */
	private IdmNotificationConfigurationDto createNotification(NotificationLevel level, String topic,
			String notificationType, UUID templateId) {
		IdmNotificationConfigurationDto notification = new IdmNotificationConfigurationDto();
