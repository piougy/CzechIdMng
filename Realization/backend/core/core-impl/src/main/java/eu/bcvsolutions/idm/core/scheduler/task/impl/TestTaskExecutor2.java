 ...
 */
@Service
@Description("Test long running task 2")
@ConditionalOnProperty(prefix = "idm.pub.app", name = "stage", havingValue = "development")
public class TestTaskExecutor2 extends AbstractSchedulableStatefulExecutor<IdmIdentityDto> {
	
	private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(TestTaskExecutor2.class);
