      ...
      <div>
        ...
        <Basic.Panel className="last">
          <Advanced.Table
            ...
            <Advanced.Column property="creator" header={this.i18n('acc:entity.ProvisioningOperation.creator')} sort face="text" />
            <Advanced.Column property="status" header={this.i18n('acc:entity.ProvisioningOperation.status')} face="text" />
          </Advanced.Table>
        </Basic.Panel>
      </div>
    );
