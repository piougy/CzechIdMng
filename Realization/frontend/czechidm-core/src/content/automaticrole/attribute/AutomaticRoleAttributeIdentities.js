...
export default class AutomaticRoleAttributeIdentities extends Advanced.AbstractTableContent {
  ...
  componentDidMount() {
    this.selectNavigationItems(['system', 'automatic-roles', 'automatic-role-attribute-identities']);
  }
  render() {
              ...
              <Basic.Row>
                <div className="col-lg-6">
                  <Advanced.Filter.TextField
                    ref="text"
                    placeholder={this.i18n('content.automaticRoles.attribute.identities.filter.text')}/>
                </div>
