...
public interface ConfigurationService {
	...
	String PROPERTY_ICON = "icon"; // @since 10.6.0 - configurable component icon
	String PROPERTY_LEVEL = "level"; // @since 10.6.0 - configurable component level (@see NotificationLevel)
	//
