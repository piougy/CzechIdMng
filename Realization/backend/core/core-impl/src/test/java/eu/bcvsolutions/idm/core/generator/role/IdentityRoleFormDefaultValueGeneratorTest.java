...
/**
 * Tests for {@link IdentityRoleFormDefaultValueGenerator}
 * 
 * @author Ondrej Kopr
 * @since 9.4.0
 *
 */
public class IdentityRoleFormDefaultValueGeneratorTest extends AbstractGeneratorTest {
	...
	public void testGreenLine() {
		...
		// check eav before
		List<IdmFormInstanceDto> eavs = identityRole.getEavs();
		assertTrue(eavs.isEmpty());

		createGenerator();

		// generate and check values after
		identityRole = this.valueGeneratorManager.generate(identityRole);
		eavs = identityRole.getEavs();
	...
	public void testGreenLineWithSave() {
		...
		// generate and check values after
		identityRole = this.identityRoleService.save(identityRole);
		eavs = identityRole.getEavs();
		assertFalse(eavs.isEmpty());
	...
	protected String getGeneratorType() {
		return IdentityRoleFormDefaultValueGenerator.class.getName();
	}
