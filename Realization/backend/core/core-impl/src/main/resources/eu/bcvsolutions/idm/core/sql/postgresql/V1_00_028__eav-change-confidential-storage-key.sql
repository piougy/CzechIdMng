...
update idm_confidential_storage set storage_key = (
	...
	where a.confidential = true and a.definition_id = d.id 
		and d.definition_type = 'eu.bcvsolutions.idm.core.model.entity.IdmIdentity' and a.code = substring(storage_key from 5)
)
...
update idm_confidential_storage set storage_key = (
	...
	from idm_form_attribute a, idm_form_definition d 
	where a.confidential = true and a.definition_id = d.id 
		and d.definition_type = 'eu.bcvsolutions.idm.core.model.entity.IdmRole' and a.code = substring(storage_key from 5)
)
...
update idm_confidential_storage set storage_key = (
	...
	from idm_form_attribute a, idm_form_definition d 
	where a.confidential = true and a.definition_id = d.id 
		and d.definition_type = 'eu.bcvsolutions.idm.core.model.entity.IdmIdentityContract' and a.code = substring(storage_key from 5)
)
...
update idm_confidential_storage set storage_key = (
	...
	from idm_form_attribute a, idm_form_definition d 
	where a.confidential = true and a.definition_id = d.id 
		and d.definition_type = 'eu.bcvsolutions.idm.core.model.entity.IdmTreeNode' and a.code = substring(storage_key from 5)
)
