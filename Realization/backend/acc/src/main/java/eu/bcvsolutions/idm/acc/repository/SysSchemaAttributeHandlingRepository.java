...
public interface SysSchemaAttributeHandlingRepository extends AbstractEntityRepository<SysSchemaAttributeHandling, SchemaAttributeHandlingFilter> {
	...
	/**
	 * Deletes all mapped attributes by given scheam attribute
	 * 
	 * @param schemaAttribute
	 * @return
	 */
	int deleteBySchemaAttribute(@Param("schemaAttribute") SysSchemaAttribute schemaAttribute);
	
	/**
	 * Deletes all mapped attributes by given mapping definition
	 * 
	 * @param systemEntityHandling
	 * @return
	 */
	int deleteBySystemEntityHandling(@Param("systemEntityHandling") SysSystemEntityHandling systemEntityHandling);
}
