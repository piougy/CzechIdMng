...
import eu.bcvsolutions.idm.acc.scheduler.task.impl.IdentityRoleValidRequestTaskExecutor;
...
public class IdentityRoleValidRequestSchedulerTest extends AbstractIntegrationTest {
	...
	public void createNonValidRoleAndValid() {
		...
		List<IdmIdentityRole> roles = identityRoleRepository.findAllByIdentityContract_Identity(identity, null);
