...
- [#2366](https://redmine.czechidm.com/issues/2366) - New caches were registered:
 ...
 - [#2371](https://redmine.czechidm.com/issues/2371) You can see all approvers via clicking on the "..." now. Table of identities is limmited on first 100 approvers now. Limitation is necessary because IDs are send in GET request and these has limitation on 8kB. I tested this on Chrome, Firefox, IE, Edge all supports 8kB.
