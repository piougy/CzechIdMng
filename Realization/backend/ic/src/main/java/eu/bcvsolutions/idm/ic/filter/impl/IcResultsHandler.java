 ...
 */
public interface IcResultsHandler {

    /**
     * Invoked each time a matching {@link IcConnectorObject} is returned from a
     * query request.
     *
     ...
     *             iteration.
     */
    boolean handle(final IcConnectorObject connectorObject);
}
