...
import AbstractLetterIcon from './AbstractLetterIcon';
import FormDefinitionIcon from './FormDefinitionIcon';
import FormProjectionIcon from './FormProjectionIcon';
import FormAttributeIcon from './FormAttributeIcon';
import FormValueIcon from './FormValueIcon';
...
Icons.FormProjectionIcon = FormProjectionIcon;
Icons.FormAttributeIcon = FormAttributeIcon;
Icons.FormValueIcon = FormValueIcon;
Icons.AutomaticRoleIcon = AutomaticRoleIcon;
Icons.AbstractLetterIcon = AbstractLetterIcon;
