# IdentityRoleInfo Component

Information about assigned role. If assigned role doesn't exist, then short identity role's identifier will be shown.
...
```html
<Advanced.IdentityRoleInfo entityIdentifier="identityRole-uuid" />
```
