...
import eu.bcvsolutions.idm.core.model.service.impl.DefaultIdmGeneratedValueService;
...
public class IdmServiceConfiguration {
	...
	@Autowired private IdmGeneratedValueRepository generatedValueRepository;
	//
	 ...
	 */
	@Bean
	@ConditionalOnMissingBean(IdmGeneratedValueService.class)
	public IdmGeneratedValueService generatedValueService() {
		return new DefaultIdmGeneratedValueService(generatedValueRepository);
	}
}
