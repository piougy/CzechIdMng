...
// class for check roles, assigned to system on "Systems" tab
...
// TODO ???
  componentDidMount() {
    this.selectNavigationItems(['systems', 'system-roles']);
  }

  showDetail(entity, add) {
    const roleId = this.props.params.entityId;
    if (add) {
      // When we add new object class, then we need id o\f role as parametr and use "new" url
