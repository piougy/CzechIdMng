 ...
 */
@Service
public class DefaultWorkflowTaskDefinitionService extends AbstractBaseDtoService<WorkflowTaskDefinitionDto, EmptyFilter>
		implements WorkflowTaskDefinitionService {
